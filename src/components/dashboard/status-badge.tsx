...
const STATUS_STYLES: Record<string, string> = {
  ...
  posted: 'bg-surface-container-highest text-on-surface-variant',
...
export function StatusBadge({ status, className }: StatusBadgeProps) {
  return (
    <span
      className={cn(
        'inline-flex items-center rounded-full px-2.5 py-0.5 text-xs uppercase tracking-wider font-body',
