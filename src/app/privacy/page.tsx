  ...
  return (
    <div className="min-h-screen bg-surface p-8 max-w-3xl mx-auto">
      ...
      <div className="space-y-4 text-on-surface-variant text-sm">
        ...
        <h2 className="text-xl text-on-surface font-display pt-4">Information We Collect</h2>
        ...
        <h2 className="text-xl text-on-surface font-display pt-4">How We Use Your Information</h2>
        ...
        <h2 className="text-xl text-on-surface font-display pt-4">Data Security</h2>
        ...
        <h2 className="text-xl text-on-surface font-display pt-4">Data Deletion</h2>
